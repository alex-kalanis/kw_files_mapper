...
class DirTest extends AStorageTest
{
    ...
    public function testRead0(): void
    {
        ...
        $procFile = new MapperNoRoot\ProcessFile(new SQLiteTestRecord(), new Process\Translate());
        $lib = new MapperNoRoot\ProcessDir(new SQLiteTestRecord(), new Process\Translate());
